...
console.log(Math.min(4, 3, 6, 8));  // isme min k mtlb hai ki sabse choti value
console.log(Math.max(4, 3, 6, 8));  // isme max k mtlb hai ki sabse badi value

console.log(Math.random  ())  // maths value hai random 0 se 1 k bich aaygi
console.log((Math.random()*10) + 1); //  isme plus 1 kr dia 
console.log(Math.floor(Math.random()*10) + 1);  // isme 10 se multiply krke 1 se plus kr dia 

const min = 10
const max = 20
                  //yeh jo hai 10 or 20 k bich mei value chiye hume koi bhi

console.log(Math.floor(Math.random() * (max - min + 1)) + min)
                               // ismme 10 or 20 k bich value chiye toh yeh yeh formula lagega okay..